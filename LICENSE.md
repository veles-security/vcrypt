...
Copyright (c) 2026 Paweł Gąsiorowski

Veles is source-available software licensed under the **PolyForm
Perimeter License 1.0.0**.

In addition to the license below, separate commercial licenses may be
available from the copyright holder for uses that are not permitted by
the PolyForm Perimeter License, including use of Veles to provide a
competing product.
...
Required Notice: Copyright (c) 2026 Paweł Gąsiorowski. Veles is licensed
under the PolyForm Perimeter License 1.0.0. Separate commercial
licensing may be available from the copyright holder.
...
product may compete regardless how it is designed or deployed. For
example, a product may compete even if it provides its functionality via
any kind of interface (including services, libraries or plug-ins), even
if it is ported to a different platforms or programming languages, and
...
The PolyForm Perimeter License allows broad use, modification, and
distribution of Veles, but does not permit using the software to provide
others with a product that competes with Veles.

If your intended use is outside those terms --- in particular, if you
want to incorporate Veles into, distribute, rebrand, or offer a product
or service that would compete with Veles --- contact the copyright
holder to discuss a separate commercial license.

A commercial license is a separate agreement and is not granted by this
file.
