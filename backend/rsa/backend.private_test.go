...
func Test_privateBackend_Supports(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Decrypt RSA1_5", use: key.KeyUseEncryption, operation: key.KeyOpDecrypt, algorithm: RSA1_5, assertion: assertSupported},
		{name: "Decrypt RSA-OAEP", use: key.KeyUseEncryption, operation: key.KeyOpDecrypt, algorithm: RSAOAEP, assertion: assertSupported},
